 ...
 */
public class TabFragmentE extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_tab_fragment_e, container, false);
    ...
    private void intidataset(){
        for (int i = 0;i<9;i++){
            ReItme itme = new ReItme("好累啊"+i,R.drawable.tu1,R.drawable.tu4);
            dataset.add(itme);
        }
